...
int main() {
    ...
    Tema temas[MAX_CATEGORIAS] = {
        {"Frutas", {
            ...
            {"naranja", "Fruta cÃƒÂ­trica y jugosa", 7},
        ...
        {"Ciudades", {
            ...
            {"madrid", "Capital de España, conocida por el Prado", 6},
        ...
        {"Peliculas", {
            {"inception", "Pelicula sobre sueños y realidades alternativas", 9},
        ...
        {"Musica", {
            ...
            {"blues", "Genero musical con raÃƒÂ­ces en la tristeza y el lamento", 5},
